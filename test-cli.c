...
int main() {
    ...
    while (1) {
        ...
        printf("8. Quit\n");
        printf("Option: ");
        option = getMenuOption(8);

        switch (option) {
            case 1: {
                int repoOption;
                while (1) {
                    printf("\nChoose an option for Repo Setup:\n");
            ...
            case 2: {
                int dnfOption;
                while (1) {
                    printf("\nChoose an option for DNF modification tool:\n");
            ...
            case 3: {
                int codecOption;
                while (1) {
                    printf("\nChoose an option for Codec Support:\n");
            ...
            case 4: {
                ...
                int packageOption;
                while (1) {
                    printf("\nChoose an option for Package Management Helper:\n");
            ...
            case 5: {
                int scriptOption;
                while (1) {
                    printf("\nChoose an option for premade script:\n");
                    printf("1. Gaming-AMD\n");
                    ...
                    switch (scriptOption) {
                        ...
                        case 7:
                            ...
                            runCommand("sudo dnf groupupdate -y multimedia --setop=\"install_weak_deps=False\" --exclude=PackageKit-gstreamer-plugin");
                            runCommand("sudo dnf groupupdate -y sound-and-video");
                            runCommand("flatpak install org.libreoffice.LibreOffice -y");
                            break;
                        case 8:
                            printf("Returning to main menu.\n");
                            break;
